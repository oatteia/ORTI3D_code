grpList=['DIS','BAS6','LPF','WEL','RCH','EVT','DRN','RIV','CHD','GHB','SIP','PCG','SOR','DE4','UPW','NWT','UZF','MNWT'] # CHD written in auro mode
groups={
...
'LPF':['lpf.0','lpf.1','lpf.2','lpf.3','lpf.4','lpf.5','lpf.6','lpf.7','lpf.8','lpf.9','lpf.10','lpf.11','lpf.12','lpf.13'],
'WEL':['wel.1'],
'RCH':['rch.1','rch.2'],
...
'UPW':['upw.1','upw.2','upw.3','upw.4','upw.5','upw.6','upw.7','upw.8','upw.9','upw.10','upw.11','upw.12'],
'NWT':['nwt.1','nwt.2','nwt.3'],
'UZF':['uzf.1','uzf.2','uzf.3','uzf.4','uzf.5','uzf.6','uzf.7','uzf.8','uzf.9','uzf.10','uzf.11','uzf.12','uzf.13','uzf.14','uzf.15','uzf.16']
}
# types
...
'nwt.1':{'comm':'General flags','cond':'',
         'kw':['HEADTOL','FLUXTOL','MAXITEROUT','THICKFACT','LINMETH','IPRNWT','IBOTAV','OPTIONS',
...
'nwt.2':{'comm':'flags for GMRES','cond':'LINMETH==1 and OPTIONS==\'SPECIFIED\'',
...
'nwt.3':{'comm':'flags for XMD','cond':'LINMETH==2 and OPTIONS==\'SPECIFIED\'',
